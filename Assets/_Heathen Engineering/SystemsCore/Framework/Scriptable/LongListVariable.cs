...
namespace HeathenEngineering.Scriptable
{
    ...
    /// </list>
    /// </example>
    [CreateAssetMenu(menuName = "List Variables/Long List")]
    public class LongListVariable : DataVariable<List<long>>
    {
        ...
        [HideInInspector]
        public List<ChangeEventListener<List<long>>> Listeners = new List<ChangeEventListener<List<long>>>();

        public override List<long> Value
        {
            get
            {
                return this.value;
        ...
        public override object ObjectValue
        {
            ...
            set
            {
                if (value.GetType() == typeof(List<long>))
                    SetValue((List<long>)value);
            }
        }

        public override void SetValue(List<long> value)
        {
            if (this.value != value)
            {
                this.value = value;
        ...
        public override void SetValue(DataVariable<List<long>> value)
        {
        ...
        public override void AddListener(ChangeEventListener<List<long>> listener)
        {
            Listeners.Add(listener);
        }

        public override void RemoveListener(ChangeEventListener<List<long>> listener)
        {
            Listeners.Remove(listener);
        }
    }
