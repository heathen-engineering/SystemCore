...
namespace HeathenEngineering.Scriptable
{
    ...
    /// </list>
    /// </example>
    [CreateAssetMenu(menuName = "List Variables/Unsigned Long List")]
    public class UnsignedLongListVariable : DataVariable<List<ulong>>
    {
        ...
        [HideInInspector]
        public List<ChangeEventListener<List<ulong>>> Listeners = new List<ChangeEventListener<List<ulong>>>();

        public override List<ulong> Value
        {
            get
            {
                return this.value;
        ...
        public override object ObjectValue
        {
            ...
            set
            {
                if (value.GetType() == typeof(List<ulong>))
                    SetValue((List<ulong>)value);
            }
        }

        public override void SetValue(List<ulong> value)
        {
            if (this.value != value)
            {
                this.value = value;
        ...
        public override void SetValue(DataVariable<List<ulong>> value)
        {
        ...
        public override void AddListener(ChangeEventListener<List<ulong>> listener)
        {
            Listeners.Add(listener);
        }

        public override void RemoveListener(ChangeEventListener<List<ulong>> listener)
        {
            Listeners.Remove(listener);
        }
    }
