...
namespace HeathenEngineering.Scriptable
{
    ...
    /// </list>
    /// </example>
    [CreateAssetMenu(menuName = "List Variables/Double List")]
    public class DoubleListVariable : DataVariable<List<double>>
    {
#if UNITY_EDITOR
        [Multiline]
        public string DeveloperDescription = "";
        ...
        [HideInInspector]
        public List<ChangeEventListener<List<double>>> Listeners = new List<ChangeEventListener<List<double>>>();
        ...
        public override void SetValue(List<double> value)
        {
            if (this.value != value)
            {
                this.value = value;
        ...
        public override void SetValue(DataVariable<List<double>> value)
        {
        ...
        public override void AddListener(ChangeEventListener<List<double>> listener)
        {
            Listeners.Add(listener);
        }

        public override void RemoveListener(ChangeEventListener<List<double>> listener)
        {
            Listeners.Remove(listener);
        }
    }
