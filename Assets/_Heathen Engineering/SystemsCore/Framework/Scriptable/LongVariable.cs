...
namespace HeathenEngineering.Scriptable
{
    ...
    public class LongVariable : DataVariable<long>
    {
        ...
        [HideInInspector]
        public List<ChangeEventListener<long>> Listeners = new List<ChangeEventListener<long>>();
        ...
        public override void SetValue(DataVariable<long> value)
        {
        ...
        public override void AddListener(ChangeEventListener<long> listener)
        {
            Listeners.Add(listener);
        }

        public override void RemoveListener(ChangeEventListener<long> listener)
        {
            Listeners.Remove(listener);
        }
    }
