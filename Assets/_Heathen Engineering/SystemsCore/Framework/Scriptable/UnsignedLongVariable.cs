...
namespace HeathenEngineering.Scriptable
{
    ...
    /// </list>
    /// </example>
    [CreateAssetMenu(menuName = "Variables/Unsigned Long")]
    public class UnsignedLongVariable : DataVariable<ulong>
    {
        ...
        [HideInInspector]
        public List<ChangeEventListener<ulong>> Listeners = new List<ChangeEventListener<ulong>>();
        ...
        public override void SetValue(DataVariable<ulong> value)
        {
        ...
        public override void AddListener(ChangeEventListener<ulong> listener)
        {
            Listeners.Add(listener);
        }

        public override void RemoveListener(ChangeEventListener<ulong> listener)
        {
            Listeners.Remove(listener);
        }
    }
