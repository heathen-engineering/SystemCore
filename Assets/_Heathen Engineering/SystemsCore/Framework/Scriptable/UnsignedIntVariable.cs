...
namespace HeathenEngineering.Scriptable
{
    ...
    /// </list>
    /// </example>
    [CreateAssetMenu(menuName = "Variables/Unsigned Int")]
    public class UnsignedIntVariable : DataVariable<uint>
    {
        ...
        [HideInInspector]
        public List<ChangeEventListener<uint>> Listeners = new List<ChangeEventListener<uint>>();
        ...
        public override void SetValue(DataVariable<uint> value)
        {
        ...
        public override void AddListener(ChangeEventListener<uint> listener)
        {
            Listeners.Add(listener);
        }

        public override void RemoveListener(ChangeEventListener<uint> listener)
        {
            Listeners.Remove(listener);
        }
    }
