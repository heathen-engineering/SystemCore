...
namespace HeathenEngineering.Scriptable
{
    ...
    /// </list>
    /// </example>
    [CreateAssetMenu(menuName = "List Variables/Float List")]
    public class FloatListVariable : DataVariable<List<float>>
    {
        ...
        [HideInInspector]
        public List<ChangeEventListener<List<float>>> Listeners = new List<ChangeEventListener<List<float>>>();
        ...
        public override void SetValue(DataVariable<List<float>> value)
        {
        ...
        public override void AddListener(ChangeEventListener<List<float>> listener)
        {
            Listeners.Add(listener);
        }

        public override void RemoveListener(ChangeEventListener<List<float>> listener)
        {
            Listeners.Remove(listener);
        }
    }
